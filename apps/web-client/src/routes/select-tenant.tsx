...
function SelectTenantPage() {
  ...
  if (!isSystemAdmin) {
      if (isInitialLoading) return <div className="flex h-screen items-center justify-center">{t('auth.loading_tenants')}</div>
      ...
      return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 text-foreground transition-colors relative">
          <div className={cn(
            ...
            <h1 className="mb-6 text-center text-2xl font-bold">{t('auth.select_tenant')}</h1>
  ...
  return (
    <div className="container mx-auto py-8 text-foreground min-h-screen pt-20">
      <div className="flex items-center justify-between mb-6">
        <div>
            <h1 className="text-2xl font-bold tracking-tight">{t('auth.select_tenant')}</h1>
                        ...
                        >
                            <td className="p-4 align-middle font-medium">
                                <div className="flex items-center gap-2">
                                    {tenant.name}
                                    {tenant.code === 'SYS' && <span className="text-[10px] bg-primary/10 text-primary px-1 rounded">SYSTEM</span>}
                                </div>
                            </td>
