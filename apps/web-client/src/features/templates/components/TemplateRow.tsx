...
import { FileText, MoreVertical, FolderOpen, Clock, GripVertical, ChevronDown } from 'lucide-react';
import type { TemplateListItem, TemplateWithAllVersions, Tag, TagWithCount } from '../types';
import { StatusBadge } from './StatusBadge';
import { TagBadgeList } from './TagBadge';
import { TemplateExpandedContent, TemplateExpandedContentSkeleton } from './TemplateExpandedContent';
  ...
  return (
    <Collapsible open={isExpanded} onOpenChange={onToggleExpand} onCloseComplete={onCloseComplete}>
      ...
      >
        ...
        <CollapsibleContent>
          {isLoadingExpanded ? (
            <TemplateExpandedContentSkeleton />
          ) : (
