 ...
 */
export type SingleSignatureLayout =
  | 'single-left'
  | 'single-center'
  | 'single-right'
 ...
 */
export type DualSignatureLayout =
  | 'dual-sides'
  | 'dual-center'
  | 'dual-left'
  | 'dual-right'
 ...
 */
export type TripleSignatureLayout =
  | 'triple-row'
  | 'triple-pyramid'
  | 'triple-inverted'
 ...
 */
export type QuadSignatureLayout =
  | 'quad-grid'
  | 'quad-top-heavy'
  | 'quad-bottom-heavy'
 ...
 */
export function getDefaultLayoutForCount(
  count: SignatureCount
): SignatureLayout {
  switch (count) {
    case 1:
