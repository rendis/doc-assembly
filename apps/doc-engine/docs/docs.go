...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/system/tenants/{tenantId}/system-workspace": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto.CreateSystemWorkspaceRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto.ListResponse-github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto_WorkspaceWithRoleResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto.CreateSystemWorkspaceRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto.ListResponse-github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto_WorkspaceWithRoleResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto.WorkspaceWithRoleResponse"
                    }
                }
            }
        },
        ...
        "github_com_doc-assembly_doc-engine_internal_adapters_primary_http_dto.WorkspaceWithRoleResponse": {
            "type": "object",
            "properties": {
                "createdAt": {
                    "type": "string"
