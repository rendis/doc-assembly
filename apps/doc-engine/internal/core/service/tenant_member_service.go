...
func (s *TenantMemberService) AddMember(ctx context.Context, cmd usecase.AddTenantMemberCommand) (*entity.TenantMemberWithUser, error) {
...
func (s *TenantMemberService) UpdateMemberRole(ctx context.Context, cmd usecase.UpdateTenantMemberRoleCommand) (*entity.TenantMemberWithUser, error) {
...
func (s *TenantMemberService) RemoveMember(ctx context.Context, cmd usecase.RemoveTenantMemberCommand) error {
	member, err := s.memberRepo.FindByID(ctx, cmd.MemberID)
	if err != nil {
