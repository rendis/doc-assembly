...
func NewTagService(tagRepo port.TagRepository) usecase.TagUseCase {
	return &TagService{
		tagRepo: tagRepo,
	}
}
...
func (s *TagService) UpdateTag(ctx context.Context, cmd usecase.UpdateTagCommand) (*entity.Tag, error) {
