...
func (s *DocumentService) CreateAndSendDocument(ctx context.Context, cmd usecase.CreateDocumentCommand) (*entity.DocumentWithRecipients, error) {
...
func (s *DocumentService) GetDocumentStatistics(ctx context.Context, workspaceID string) (*usecase.DocumentStatistics, error) {
	...
	return &usecase.DocumentStatistics{
		Total:      total,
		Pending:    pending,
...
var _ usecase.DocumentUseCase = (*DocumentService)(nil)
