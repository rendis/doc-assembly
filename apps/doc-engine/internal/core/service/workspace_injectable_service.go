...
func NewWorkspaceInjectableService(repo port.WorkspaceInjectableRepository) usecase.WorkspaceInjectableUseCase {
...
func (s *WorkspaceInjectableService) CreateInjectable(ctx context.Context, cmd usecase.CreateWorkspaceInjectableCommand) (*entity.InjectableDefinition, error) {
...
func (s *WorkspaceInjectableService) UpdateInjectable(ctx context.Context, cmd usecase.UpdateWorkspaceInjectableCommand) (*entity.InjectableDefinition, error) {
