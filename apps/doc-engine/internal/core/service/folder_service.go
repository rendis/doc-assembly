...
func NewFolderService(folderRepo port.FolderRepository) usecase.FolderUseCase {
...
func (s *FolderService) CreateFolder(ctx context.Context, cmd usecase.CreateFolderCommand) (*entity.Folder, error) {
...
func (s *FolderService) UpdateFolder(ctx context.Context, cmd usecase.UpdateFolderCommand) (*entity.Folder, error) {
...
func (s *FolderService) MoveFolder(ctx context.Context, cmd usecase.MoveFolderCommand) (*entity.Folder, error) {
	folder, err := s.folderRepo.FindByID(ctx, cmd.ID)
	if err != nil {
		return nil, fmt.Errorf("finding folder: %w", err)
	}
