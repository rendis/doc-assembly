...
) usecase.WorkspaceMemberUseCase {
...
func (s *WorkspaceMemberService) InviteMember(ctx context.Context, cmd usecase.InviteMemberCommand) (*entity.MemberWithUser, error) {
...
func (s *WorkspaceMemberService) UpdateMemberRole(ctx context.Context, cmd usecase.UpdateMemberRoleCommand) (*entity.MemberWithUser, error) {
...
func (s *WorkspaceMemberService) RemoveMember(ctx context.Context, cmd usecase.RemoveMemberCommand) error {
	member, err := s.memberRepo.FindByID(ctx, cmd.MemberID)
	if err != nil {
