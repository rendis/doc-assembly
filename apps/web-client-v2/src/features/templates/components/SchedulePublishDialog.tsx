        ...
        <div className="space-y-6 p-6">
          ...
          <div>
            ...
            <input
              ...
              min={getMinDate()}
              className="w-full rounded-none border-0 border-b border-border bg-transparent py-2 text-base font-light text-foreground outline-none transition-all focus:border-foreground focus:ring-0"
            />
          </div>
