  ...
  return (
    <NodeViewWrapper className="my-6">
      ...
      >
        ...
        <div
          className="absolute top-2 right-2 flex items-center gap-1 px-2 py-0.5 rounded bg-black/10 hover:bg-black/20 text-gray-600 text-[10px] font-medium border border-gray-200 transition-all cursor-pointer shadow-sm"
