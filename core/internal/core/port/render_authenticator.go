...
// When registered via the extensibility system (//docengine:render_auth),
// it replaces default OIDC for render routes while panel OIDC continues
// working for login/UI.
