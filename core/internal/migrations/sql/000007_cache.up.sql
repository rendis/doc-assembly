...
CREATE TABLE organizer.workspace_tags_cache (
    ...
    CONSTRAINT workspace_tags_cache_pkey PRIMARY KEY (tag_id)
);
...
-- ========== TRIGGER FUNCTION: on_tag_insert ==========
...
-- ========== TRIGGER FUNCTION: on_tag_update ==========
...
-- ========== TRIGGER FUNCTION: on_template_tag_insert ==========
...
-- ========== TRIGGER FUNCTION: on_template_tag_delete ==========
