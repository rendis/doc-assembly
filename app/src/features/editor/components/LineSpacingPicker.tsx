...
function getCurrentLineSpacing(editor: Editor): LineSpacingPreset {
  const paragraphSpacing = editor.getAttributes('paragraph').lineSpacing as string | undefined
  const headingSpacing = editor.getAttributes('heading').lineSpacing as string | undefined
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <span className="truncate">{t(LINE_SPACING_PRESETS[currentSpacing].labelKey)}</span>
